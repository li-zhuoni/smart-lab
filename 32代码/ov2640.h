...
#define OV2640_PWDN(x)  	HAL_GPIO_WritePin(GPIOD,GPIO_PIN_0,x)//PGout(9)			//POWER DOWN控制信号 
#define OV2640_RST(x)  	HAL_GPIO_WritePin(GPIOD,GPIO_PIN_1,x)//PGout(15)			//复位控制信号 
////////////////////////////////////////////////////////////////////////////////// 
